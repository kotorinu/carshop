...
const RE = {
  ...
  btob: /BtoB|B2B|toB向け|法人(営業|向け|様|開拓|顧客)|企業(向け|様|担当者|開拓)|中小企業|店舗(オーナー|経営者)(様)?(向け|へ)|代表者様|(企業|法人|事業者|経営者|店舗)[^。\n]{0,6}(向け|様)[^。\n]{0,8}(支援|サポート|コンサル|集客|マーケティング)/i,
  ...
  handover: new RegExp([
    'アポ(イント)?[^。\\n]{0,24}?(お渡し|渡します|渡して|支給|供給|提供|ご用意|用意し|譲渡|固定)',
...
export function stripNegated(text) {
  return String(text || '').replace(
    /(新規開拓|飛び込み|テレアポ|架電|自分でアポ|アポ取り)[^。\n]{0,16}?(ありません|ございません|不要|なし|しません|一切|行いません|お任せしません)/g,
    '',
  );
}
